...
/// \file
/// A command line example of the features of the Metronome class. You can start and stop the metronome, adjust tempo and
/// set othe parameters. Compile it together with functions.cpp, which contains I/O functions.
